...
def add_nftables(net):
    ### STATIC ROUTES ###
    info(net['r1'].cmd("sudo nft -f basic_protection_firewalls/r1.nft"))
    info(net['r2'].cmd("sudo nft -f basic_protection_firewalls/r2.nft"))
...
def run():
    ...
    # Save the IP and MAC addresses to a text file
